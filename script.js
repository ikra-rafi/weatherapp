...
async function displayWeather() {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + cityname + "&units=imperial&appid=11a8fa0ce12a0fd2e8b95a133bce916a"
    var response = await $.ajax({
        ...
        var uvURL = "https://api.openweathermap.org/data/2.5/uvi?appid=11a8fa0ce12a0fd2e8b95a133bce916a&lat="+getLat+"&lon="+getLong;
...
async function displayFiveDayForecast() {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/forecast?q="+cityname+"&units=imperial&appid=11a8fa0ce12a0fd2e8b95a133bce916a";
